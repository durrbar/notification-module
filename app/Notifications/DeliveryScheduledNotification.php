...
class DeliveryScheduledNotification extends BaseNotification
{
    ...
    {
        return __('notification::delivery.scheduled.category');
    }
    ...
    {
        return __('notification::delivery.scheduled.database_title');
    }
    ...
    {
        return __('notification::delivery.scheduled.subject');
    }
    ...
    {
        $mail->greeting(__('notification::delivery.scheduled.mail_greeting', [
            'name' => $this->user->name,
        ]))
            ->line($this->getMessageText())
            ->action(
                __('notification::delivery.scheduled.view_order_details'),
                url('/delivery/'.$this->delivery->id)
            )
            ->line(__('notification::delivery.scheduled.mail_footer'))
            ->salutation(__('notification::delivery.scheduled.mail_salutation'));
    }
    ...
    {
        return __('notification::delivery.scheduled.message', [
